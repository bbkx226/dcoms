...
public class OrderFunction  {
    ...
    public void createOrder() throws MalformedURLException, NotBoundException, RemoteException {
        ...
        // step 3 get quantity
        int getQty = getOrderQuantity(selectedFoodId);

         // step 4 check order create
        boolean orderCreated = orderService.addOrder(selectedUserId, selectedFoodId, getQty);
    ...
    public void updateOrder() throws MalformedURLException, NotBoundException, RemoteException {
        ...
        while (true) {
            try {
                ...
                Table table = new Table("McGee's Order List", new ArrayList<>(), optionsID, prompt, "");
                // ClearScreen.clrscr();
                ...
                table.displayTable(rows, titles); // display order data table
